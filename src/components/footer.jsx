					...
					<div className="col-md-4 col-lg-5">
						<div className="row">
							<div className="img-footer col-md-12 col-lg-8 mb-md-0 mb-4">
								...
								<img src="./assets/logo/WSO2.jpeg" alt="" className="img-fluid"/>
						...
						<div className="row">
							<div className="col-md-4 mb-md-0 mb-4 border-left">
								...
								<ul className="list-unstyled">
                                    ...
                                    <li><a href="/faq" className="py-1 d-block"><i className="fab fa-question me-1"></i>Mechanism</a></li>
                                    <li><a href="https://www.iysaolympiad.or.id/" target="_blank" className="py-1 d-block"><i className="fa fa-house me-1"></i>Our Main Website</a></li>
                                </ul>
							</div>
							<div className="col-md-4 mb-md-0 mb-4 border-left">
							...
							<div className="col-md-4 mb-md-0 mb-4 border-left">
								...
								<ul className="list-unstyled">
                                    ...
                                    <li><a href="https://www.instagram.com/wso.officiall/" target="_blank" className="py-1 d-block"><i className="fab fa-instagram me-1"></i>Instagram</a></li>
