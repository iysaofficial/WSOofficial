function MainHero() {
    ...
    return (
      <>
      <section className="mainhero-section" id="mainhero">
                ...
                <div class="wrapper mx-auto" >
                    <div class="d-flex justify-content-center align-items-center text-center">
                        <div class="content-text">
                            ...
                            <a class="btn btn-outline-light btn-lg " role="button" href="https://registration-wso-2025.vercel.app/" target="_blank">Registration</a>
                        </div>
                        <div>
                        </div>
                    </div>
